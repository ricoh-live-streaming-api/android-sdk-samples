...
open class BaseActivity : PluginActivity() {
    companion object {
    ...
    /** View Binding */
    open lateinit var mActivityMainBinding: ActivityMainBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val captureFormat = CaptureFormat(ShootingMode.RIC_MOVIE_PREVIEW_3840, StitchingMode.RIC_STATIC_STITCHING, 20)
        ...
        mActivityMainBinding.saveConfig.setOnClickListener {
            Config.setRoomId(applicationContext, mActivityMainBinding.roomId.text.toString())
        ...
        mActivityMainBinding.logLevel.onItemSelectedListener = object : AdapterView.OnItemSelectedListener {
            ...
            override fun onItemSelected(parent: AdapterView<*>?, view: View?, position: Int, id: Long) {
                Config.setLoggingSeverity(this@BaseActivity.applicationContext, mActivityMainBinding.logLevel.selectedItem.toString())
            }
        }
        ...
        mActivityMainBinding.roomType.onItemSelectedListener = object : AdapterView.OnItemSelectedListener {
            override fun onNothingSelected(parent: AdapterView<*>?) {}
            override fun onItemSelected(parent: AdapterView<*>?, view: View?, position: Int, id: Long) {
                Config.setRoomType(this@BaseActivity.applicationContext, position, mActivityMainBinding.roomType.selectedItem as RoomSpec.RoomType)
            }
        }
            ...
            override fun onKeyLongPress(keyCode: Int, keyEvent: KeyEvent) {
                if (keyCode == KeyReceiver.KEYCODE_CAMERA) {
                    ...
                    try {
                        ...
                        LOGGER.warn("Failed to release capturer")
                    }
    ...
    inner class ClientListener : Client.Listener {
        override fun onConnecting(event: LSConnectingEvent) {
            ...
            runOnUiThread {
                ...
                mActivityMainBinding.activityChangeButton.isEnabled = false
            }
        }
        ...
        override fun onClosed(event: LSClosedEvent) {
            ...
            runOnUiThread {
                mActivityMainBinding.liveStreamingStateText.text = mClient?.state.toString()
                mActivityMainBinding.activityChangeButton.isEnabled = true
            }
